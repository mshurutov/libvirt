...
# (c) 2024, Mikhail Shurutov <shurutov@gmail.com> based on Sofiane Medjkoune <sofiane@medjkoune.fr> based on lxd_profile by Hiroaki Nakamura <hnakamur@gmail.com>
...
options:
    ...
    type:
        description:
          - The following network types are available: 'bridge','ovn','macvlan','sriov','physical'
        required: true
        default: 'bridge'
    url:
        description:
